...
Goの文法とポインタから始めたい場合は、先に **[Go 12日間 — 銀行口座システム](https://charliewei1.github.io/example-bank/)** をどうぞ。
構造体、ポインタ、インターフェース、エラー設計、並行処理、HTTP APIまでを12日で扱います。
このコースはその続きにあたり、同じ `./study` の進め方です。
